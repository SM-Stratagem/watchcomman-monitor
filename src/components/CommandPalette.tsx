...
const ITEMS: Item[] = [
  ...
  { group: "Intel",    label: "Time machine",       href: "/timeline",       hint: "24h to 30d scrub" },
  ...
  { group: "Tools",    label: "Briefing — 24h",     href: "/briefing?since=24", hint: "Printable HTML" },
  { group: "Tools",    label: "Briefing — 12h",     href: "/briefing?since=12" },
  { group: "Tools",    label: "Briefing — 1 week",  href: "/briefing?since=168" },
  { group: "Tools",    label: "3D Globe",           href: "/globe",          hint: "Hand-shaded atlas" },
  { group: "Tools",    label: "Source health",      href: "/source-health",  hint: "Per-feed status" },
  { group: "Tools",    label: "My account",         href: "/account",        hint: "Supporter dashboard" },
